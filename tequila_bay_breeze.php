...
$page_identifier = "tequila_bay_breeze.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: tequila_bay_breeze.php");
        exit;
    }
}
...
<img src="img/tequilabaybreeze.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Tequila Bay Breeze</h1>
...
<div class="">
            ...
            Combine all ingredients. Stir well. Serve over ice in highball glass. Garnish with pineapple slice.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="tequila_bay_breeze.php" method="post">
