...
$page_identifier = "classic_hornitos_paloma.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: classic_hornitos_paloma.php");
        exit;
    }
}
...
<img src="img/hornitospaloma.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Classic Hornitos&reg; Paloma</h1>
        <p class="text-white pb-10">Translating "Dove" in Spanish, a delicious tequila paloma always soars as an afternoon delight. Hornitos® Plata Tequila, showcasing the authentic 100% agave flavor, is elevated with the tangy essence of fresh ruby red grapefruit juice. Club soda adds effervescence to this cocktail, while the addition of fresh rosemary brings forth a hint of floral sweetness. Indulge and unwind with this refreshing grapefruit cocktail during your mid-day siesta.</p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1 part Hornitos&reg; Plata tequila</p>
            <p class="text-white pb-1">2 parts Ruby red or pink grapefruit juice</p>
            <p class="text-white pb-1">1 part Simple syrup</p>
            <p class="text-white pb-1">Garnish: Fresh rosemary springs, grapefruit or lime slices</p>
...
<div class="">
            ...
            In a tall glass filled with fresh ice, layer the ingredients in the order listed. Stir once before adding soda and then stir again after. Garnish with a slice of lime or grapefruit and a sprig of rosemary for a finishing touch.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="classic_hornitos_paloma.php" method="post">
