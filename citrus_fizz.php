...
$page_identifier = "citrus_fizz.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: citrus_fizz.php");
        exit;
    }
}
...
<img src="img/citrusfizz.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Citrus Fizz</h1>
        <p class="text-white pb-10">Effervescent and bursting with flavor, this sparkling cocktail is an ideal choice for Valentine's Day celebrations or a glamorous girls' night, whether you're out on the town or staying in. Crafted with one part Pinnacle® vodka and two parts club soda, this citrus-infused vodka fizz is simplicity at its finest. And with its irresistible taste, it's guaranteed to disappear in the blink of an eye.
            </p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1 part Citrus vodka</p>
            <p class="text-white pb-1">2 parts Club soda</p>
            <p class="text-white pb-1">Garnish with raspberries</p>
            <p class="text-white pb-1">Garnish with Lemon wheel</p>
            <p class="text-white pb-1"></p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">Combine the ingredients and pour over ice. Enhance with raspberries and a lemon wheel as garnish before serving.</p>
        </div>
</div>
...
<section class="py-8 lg:py-16 antialiased">
    <div class="max-w-2xl mx-auto px-4">
        ...
        $comments_result = get_comments($page_identifier);
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="citrus_fizz.php" method="post">
