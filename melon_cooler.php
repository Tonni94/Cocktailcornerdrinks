...
$page_identifier = "melon_cooler.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: melon_cooler.php");
        exit;
    }
}
...
<img src="img/meloncooler.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Melon Cooler</h1>
        <p class="text-white pb-10">Invigorate your senses with a melon-infused cocktail that's as refreshing as a cucumber and as sweet as honey. Muddled cucumbers provide a clean and crisp taste, perfectly balanced by the sweetness of Midori® liqueur. Finished with a squeeze of fresh lime, this melon cooler is an ideal choice for enjoying on the patio.</div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            ...
            <p class="text-white pb-1">½ part Melon liqueur</p>
            <p class="text-white pb-1">½ part Lime juice</p>
            <p class="text-white pb-1">1/4 part Simple syrup</p>
            <p class="text-white pb-1">Slices of cucumber and lime</p>
            <p class="text-white">Melon balls</p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">In a mixing tin, gently muddle cucumbers, lime juice, and simple syrup. Add ice, vodka, and melon liqueur, then shake well. Strain the mixture over ice in a Collins glass. Optionally, top with soda water for extra effervescence. Garnish with a lime wheel and melon balls to add a visually appealing touch.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="melon_cooler.php" method="post">
