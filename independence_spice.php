...
$page_identifier = "independence_spice.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: independence_spice.php");
        exit;
    }
}
...
<img src="img/independence.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Independence Spice</h1>
        <p class="text-white pb-10">From fireworks to firing up the grill, toast America’s cherished holiday with a 4th of July cocktail. This bourbon wine concoction combines sweet ripe blackberries and simple syrup, perfectly balanced by refreshing mint and zesty lemon. Elevate the presentation with additional blackberries and mint garnish for a sophisticated and patriotic beverage that's perfect for sipping all day long.</p>
    </div>
        ...
        <div class="flex list-none text-[#855200] justify-around text-center align-center items-center border bg-[#f9d342] py-10 rounded-lg">
            <div class="list-item">
                ...
                <p>Bourbon, Champagne / Sparkling wine</p>
            </div>
            <div class="list-item">
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            ...
            <p class="text-white pb-1">½ part Fresh lemon juice</p>
            <p class="text-white pb-1">3/4 part Simple syrup</p>
            <p class="text-white pb-1">Blackberries</p>
            <p class="text-white pb-1">Fresh mint leaves</p>
            <p class="text-white">2-3 parts Wine, sparkling</p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">
            Start by muddling 6 blackberries and 6 mint leaves in a Boston Shaker with ¼ part of simple syrup.
In a separate mixing glass, combine Basil Hayden's® Bourbon, lemon juice, and the remaining simple syrup. Pour this mixture into the muddled blackberries and mint leaves.
Add ice to the shaker and shake well.
Double strain the mixture into a Collins glass filled with fresh crushed ice.
Top it off with sparkling wine.
Finish by garnishing with a skewered mint leaf and a blackberry for an elegant touch.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="independence_spice.php" method="post">
