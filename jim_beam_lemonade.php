...
$page_identifier = "jim_beam_lemonade.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: jim_beam_lemonade.php");
        exit;
    }
}
...
<img src="img/jimbeamlemonade.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Jim Beam&reg; Lemonade</h1>
        <p class="text-white pb-10">

        With its refreshing and tangy flavor profile, Jim Beam&reg; Lemonade is a delightful whiskey cocktail that strikes the perfect balance. Made with just two main ingredients - Jim Beam&reg; Bourbon Whiskey and lemonade - this cocktail is easy to whip up in no time. It's the ideal summertime indulgence, perfect for pool parties, backyard barbecues, or simply lounging on the deck and soaking up the sunshine.</p>
    </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1 part Jim Beam&reg; original</p>
            <p class="text-white pb-1">2 parts lemonade</p>
            <p class="text-white pb-1">Garnish: Lemon slice</p>
...
<div class="">
            ...
            Simply combine the ingredients with ice in a cocktail glass. Garnish with a slice of lemon for a refreshing finishing touch. Enjoy your Jim Beam® Lemonade!
            </p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="jim_beam_lemonade.php" method="post">
