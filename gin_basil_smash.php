...
$page_identifier = "gin_basil_smash.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: gin_basil_smash.php");
        exit;
    }
}
...
<img src="img/ginbasilsmash.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Gin Basil Smash</h1>
        <p class="text-white pb-10">Even in modern times, new classics continue to emerge, and the Gin Basil Smash is a prime example of this evolution. A true classic is characterized by simplicity, universality, and, above all, exceptional taste. The Gin Basil Smash meets all these criteria with just four essential ingredients.</p>
    </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1½ parts Gin</p>
            <p class="text-white pb-1">½ part Simple syrup</p>
            <p class="text-white pb-1">½ part Lemon juice</p>
            <p class="text-white pb-1">Basil leaves(for muddling and garnish)</p>
            <p class="text-white pb-1"></p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">In the bottom of a cocktail shaker, gently muddle fresh basil. Fill the shaker with ice, then add the remaining ingredients. Shake vigorously, strain the mixture through a double strainer into an ice-filled rocks glass, and finally, garnish with a basil leaf for an extra touch of freshness. Cheers to the delightful Gin Basil Smash!</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="gin_basil_smash.php" method="post">
