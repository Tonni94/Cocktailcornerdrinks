...
$page_identifier = "last_word.php"; // Change this to match the identifier for your page
...
<img src="img/lastword.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Last Word</h1>
        <p class="text-white pb-10">Once a fixture in speakeasies, this distinguished cocktail now finds its home right in your own space. With a blend of London Dry Gin and an evening standout, this well-chilled coupe glass delight adds a touch of class to every evening.</p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            ...
            <p class="text-white pb-1">1 part Maraschino liqueur</p>
            <p class="text-white pb-1">1 part Green chartreuse liqueurr</p>
...
<div class="">
            ...
            Mix all the ingredients in an ice-filled shaker and shake until thoroughly chilled. Double strain the mixture into a coupe glass for a refined presentation.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="last_word.php" method="post">
