...
$page_identifier = "sipsmith_martini.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: sipsmith_martini.php");
        exit;
    }
}
...
<img src="img/sipsmithmartini.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Sipsmith&reg; Martini</h1>
        <p class="text-white pb-10">If you're in search of a timeless and iconic cocktail, consider the Sipsmith® Martini. The key lies in selecting top-quality gin, the freshest vermouth, ice chilled to perfection, and a freshly cut lemon twist. With these simple ingredients, you'll be effortlessly playing bartender from the comfort of your kitchen island in no time.
        </p>
    </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">5 parts Sipsmith&reg; London dry gin</p>
            <p class="text-white pb-1">1 Vermouth</p>
...
<div class="">
            ...
            <p class="text-white pb-5">In a mixing glass filled with ice, pour 1 part Vermouth and stir gently for a few seconds. Next, add 5 parts Sipsmith® London Dry Gin and briskly stir for 50 turns.
            Once mixed, strain the cocktail into a chilled martini glass and garnish with a twist of lemon for a classic touch. Enjoy your perfectly crafted Sipsmith® Martini!</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="sipsmith_martini.php" method="post">
