...
$page_identifier = "moscow_mule.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: moscow_mule.php");
        exit;
    }
}
...
<img src="img/moscowmule.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Moscow Mule</h1>
        <p class="text-white pb-10">Add some excitement to your day with this tantalizing ginger-infused beverage. The Moscow Mule blends spicy ginger beer, zesty lime, and vodka for a vibrant cocktail experience. Its warming effect is perfect for chilly days, while the refreshing lime provides a cooling touch on warmer ones.
            </p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">2 parts Vodka</p>
            <p class="text-white pb-1">1 part Lime juice</p>
            <p class="text-white pb-1">4 parts Ginger Beer</p>
            <p class="text-white pb-1">10- 15 Fresh Mint Leaves</p>
            <p class="text-white pb-1">Lime Wedges</p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">Serve over crushed ice in copper mug and garnish with lime wedge.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="moscow_mule.php" method="post">
