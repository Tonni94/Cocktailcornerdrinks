...
$page_identifier = "sloe_gin_fizz.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: sloe_gin_fizz.php");
        exit;
    }
}
...
<img src="img/sloeginfizz.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Sloe Gin Fizz</h1>
        <p class="text-white pb-10">
Balancing tartness and sweetness, the Sloe Gin Fizz by DeKuyper&reg; is a delightful blend perfect for any occasion, whether it's entertaining guests or unwinding after a long day. This recipe combines soda water, gin, sloe gin, and a splash of lemon juice to create a refreshing and vibrant cocktail that's sure to please.
        </p>
    </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1½ parts DeKuyper&reg; Sloe Gin</p>
            <p class="text-white pb-1">1½ parts Gin</p>
            <p class="text-white pb-1">1 part Lemon juice</p>
            <p class="text-white pb-1">3 parts Soda water</p>
            <p class="text-white pb-1"></p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">Simply build the cocktail over ice, give it a gentle stir, and it's ready to be served. Enjoy the delightful flavors of the Sloe Gin Fizz!</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="sloe_gin_fizz.php" method="post">
