...
$page_identifier = "don_francisco_margarita.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: don_francisco_margarita.php");
        exit;
    }
}
...
<img src="img/donfranciscomargarita.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Don Francisco Margarita</h1>
        <p class="text-white pb-10">In 1974, Don Francisco Javier Sauza achieved a monumental feat by establishing the Jalisco region as the exclusive origin of authentic Tequila. His unwavering commitment to innovation alongside the preservation of tradition endures, exemplified in a Tequila crafted to pay homage to Mexican Independence in all its facets.</p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">2 parts Hornitos&reg; plata tequila</p>
            <p class="text-white pb-1">1 part Orange juice</p>
            <p class="text-white pb-1">½ part Fresh squeezed lime juice</p>
            <p class="text-white pb-1">3/4 part Honey syrup</p>
            <p class="text-white pb-1">Garnish: Orange wheel, edible marigold</p>
            <p class="text-white">Salt and chilipowder for rim</p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">
            On a plate, mix equal parts salt and chili powder. Moisten the rim of a glass with an orange or lime wedge, then gently roll it in the salt and chili powder mixture. In an ice-filled shaker, combine cocktail ingredients and shake until thoroughly chilled. Strain the mixture into the rimmed rocks glass over fresh ice. Garnish with an orange wheel and edible marigold for an added touch of flavor and elegance.</p>
        </div>
</div>
...
?>
        <!-- Post Comment Form -->
        <form class="mb-6" action="don_francisco_margarita.php" method="post">
