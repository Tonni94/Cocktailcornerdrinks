...
$page_identifier = "half_half_punch.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: half_half_punch.php");
        exit;
    }
}
...
<img src="img/halfhalfpunch.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Half & Half Punch</h1>
        <p class="text-white pb-10">Add a refreshing twist to your summer get-togethers with this crowd-pleasing delight! Bring together the timeless duo of lemonade and iced tea, enhance it with the velvety touch of vodka, and add a splash of peach schnapps for an extra layer of flavor. This punch is the perfect addition to any party, ensuring your guests stay cool and satisfied. Cheers to making unforgettable memories with this refreshing concoction!</p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            ...
            <p class="text-white pb-1">2 parts Lemonade</p>
            <p class="text-white pb-1">2 parts Iced Tea</p>
            <p class="text-white pb-1">Splash of DeKuyper&reg; Peachtree&reg; Schnapps</p>
            <p class="text-white pb-1">Lemon Wedge garnish</p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">
            Mix all the ingredients together in a punch bowl or pitcher, then serve the refreshing concoction over ice. It's that simple! Enjoy your deliciously chilled summer punch.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="half_half_punch.php" method="post">
