...
$page_identifier = "hot_toddy.php"; // Change this to match the identifier for your page
...
<img src="img/hottoddy.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Hot Toddy</h1>
        <p class="text-white pb-10">Indulge in the cozy comfort of a hot toddy on a chilly winter's day! This delightful concoction combines honey, sugar, and zesty lemon flavors with the exquisite, smooth, full-bodied taste of aged dark rum. Whether you're hosting holiday gatherings or cuddling up by the fire with your special someone, this hot toddy rum recipe is sure to warm you up from the inside out.
            </p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            ...
            <p class="text-white pb-1">1 bar spoon Honey</p>
            <p class="text-white pb-1">1 large Lemon peel</p>
            <p class="text-white pb-1">1 ounce Hot water</p>
            <p class="text-white pb-1"></p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">Prepare a mug by rinsing it with boiling water and pouring out the excess. Add honey (or sugar) and the lemon peel, then pour in an ounce of hot water and stir until the sweetener has dissolved. Finally, add dark rum and top off with more boiling water. Enjoy your comforting hot toddy!</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="hot_toddy.php" method="post">
