...
$page_identifier = "gin_tonic.php"; // Change this to match the identifier for your page
...
<img src="img/gintonic.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Gin Tonic</h1>
        <p class="text-white pb-10">When crafted with care, the gin and tonic, a quintessential English classic, achieves nothing short of alchemic perfection.</p>
    </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1 part Gin</p>
            <p class="text-white pb-1">2 parts Tonic water</p>
...
<div class="">
            ...
            <p class="text-white pb-5">Fill your glass to the brim with ice, then garnish with a twist of lemon for the perfect finishing touch.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="gin_tonic.php" method="post">
