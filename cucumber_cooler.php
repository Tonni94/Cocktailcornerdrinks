...
$page_identifier = "cucumber_cooler.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: cucumber_cooler.php");
        exit;
    }
}
...
<img src="img/cucumbercooler.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Cucumber Cooler</h1>
        <p class="text-white pb-10">Drawing inspiration from the essence of sun-ripened fruits and vegetables, this cucumber vodka concoction is a blend of crispness, cleanliness, and unexpected sweetness. The vibrant green hue of melon-flavored Midori® liqueur infuses the cucumber cooler with a refreshing twist, complemented by the fresh flavor of EFFEN® vodka. A dash of tart lime and simple syrup adds the perfect balance, creating a well-rounded cocktail that's ideal for sipping outdoors.</div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">2 parts Cucumber vodka</p>
            <p class="text-white pb-1">3/4 part Melon liqueur</p>
            <p class="text-white pb-1">3/4 part Fresh lime juice</p>
            <p class="text-white pb-1">1/2 part Simple syrup</p>
            <p class="text-white pb-1">3 Slices of cucumber</p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">In a mixing tin, gently muddle cucumbers with lime juice and simple syrup. Add ice, followed by Midori® Melon Liqueur and vodka. Shake vigorously, then strain the mixture into a rocks glass. Finish it off with a garnish of cucumber slices for a refreshing touch.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="cucumber_cooler.php" method="post">
