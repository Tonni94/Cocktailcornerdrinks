...
$page_identifier = "tom_collins.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: tom_collins.php");
        exit;
    }
}
...
<img src="img/tomcollins.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Tom Collins</h1>
        <p class="text-white pb-10">The origin of the name "Tom Collins" may be disputed, but one thing everyone can agree on is its refreshing appeal, especially after brunch. Made with Sipsmith® London Dry Gin, lemon juice, club soda, and simple syrup, this vibrant and effervescent cocktail is the perfect addition to any outdoor gathering, whether it's a picnic in the park or a leisurely afternoon on the porch. Cheers to enjoying this sparkling social delight!
            </p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            ...
            <p class="text-white pb-1">1 part Fresh lemon juice</p>
            <p class="text-white pb-1">½ part Simple syrup</p>
            <p class="text-white pb-1">Club soda</p>
            <p class="text-white pb-1">Garnish: Orange slice</p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">In a Collins glass filled with ice, combine gin, lemon juice, and simple syrup. Give it a gentle stir, then top it off with soda water. Finish by garnishing with an orange slice for a refreshing and citrusy touch. Enjoy your delightful Tom Collins!</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="tom_collins.php" method="post">
