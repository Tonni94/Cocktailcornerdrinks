...
$page_identifier = "vodka_lemonade.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: vodka_lemonade.php");
        exit;
    }
}
...
<img src="img/vodkalemonade.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Vodka Lemonade</h1>
        <p class="text-white pb-10">Elevate your classic lemonade with an adult-only twist that adds a tangy kick to a familiar favorite. This vodka lemonade brings together tangy citrus flavors with a soulful vodka infusion, creating a refreshing drink that's both effortless to make and delightful to sip on. Serve it up with some fresh lemon slices for a simple summer cocktail that's sure to please any crowd. Cheers to enjoying the perfect blend of sweet and tangy!</p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            ...
            <p class="text-white pb-1">Garnish: Lemon wheel</p>
...
<div class="">
            ...
            Combine the ingredients and serve the refreshing mixture over ice. Garnish each glass with a lemon wheel for an extra touch of citrusy flavor and visual appeal. Enjoy your perfectly chilled vodka lemonade!</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="vodka_lemonade.php" method="post">
