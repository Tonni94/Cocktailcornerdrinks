...
$page_identifier = "haku_highball.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: haku_highball.php");
        exit;
    }
}
...
<img src="img/hakuhighball.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Haku Highball</h1>
        <p class="text-white pb-10">Straight from the prestigious House of Suntory to your home, enjoy this effortlessly crafted, pleasantly unexpected refreshment. Haku®'s smooth, rounded flavor elevates the classic vodka soda, offering a sophisticated twist to your gatherings.</div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1 part Suntory Haku&reg;</p>
            <p class="text-white pb-1">3 parts Chilled Fever-Tree club soda</p>
...
<div class="">
            ...
            <p class="text-white pb-5">Start by generously filling a highball glass with ice. Pour in Haku® Vodka and then gently top it off with chilled soda water. Give it a quick stir to mix everything together, and finally, add a finishing touch with a twist of lemon peel as garnish.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="haku_highball.php" method="post">
