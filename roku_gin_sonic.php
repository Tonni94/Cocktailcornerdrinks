...
$page_identifier = "roku_gin_sonic.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: roku_gin_sonic.php");
        exit;
    }
}
...
<img src="img/rokuginsonic.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Roku&reg; Gin Sonic</h1>
        <p class="text-white pb-10">With a lighter touch than the traditional Gin & Tonic, the Roku&reg; Sonic still boasts plenty of character. A blend of soda water and tonic water enhances the delicate floral nuances of the six distinctive botanicals found in this Japanese Gin. Whether you're unwinding on the back deck or enjoying a summertime meal, pour yourself one to savor the refreshing essence of this delightful drink.
            </p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1 part Suntory Roku&reg; Gin</p>
            <p class="text-white pb-1">½ parts Chilled soda water</p>
            <p class="text-white pb-1">1½ parts Chilled tonic water</p>
            <p class="text-white pb-1">Garnish: Lemon peel</p>
            <p class="text-white pb-1"></p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">Begin by filling a highball glass to the brim with ice.
Pour in Roku® Gin followed by equal parts soda and tonic water.
Gently stir to combine the ingredients.
Finish by garnishing with a twist of lemon peel for a citrusy touch. Enjoy your refreshing Roku® Sonic!</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="roku_gin_sonic.php" method="post">
