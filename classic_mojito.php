...
$page_identifier = "classic_mojito.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: classic_mojito.php");
        exit;
    }
}
...
<img src="img/classicmojito.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Classic Mojito</h1>
        <p class="text-white pb-10">Crafted to perfection, this timeless mojito cocktail is a tantalizing delight. The refreshing mint intertwines seamlessly with the smooth notes of Cruzan® Aged Light Rum, offering an irresistible taste of the islands. Whether amidst the hustle of a busy day or the tranquility of a weekend, take a moment to unwind and savor this mojito leisurely.</p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1 ½ parts Cruzan® Aged Light Rum</p>
            <p class="text-white pb-1">1 part Simple Syrup</p>
            <p class="text-white pb-1">2 Lime Wedges</p>
            <p class="text-white pb-1">10- 15 Fresh Mint Leaves</p>
            <p class="text-white pb-1"> Splash of Soda Water</p>
            <p class="text-white"> Garnish: Mint Sprig, Lime Wheel</p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">In a tall highball glass, softly crush mint together with lime wedges and simple syrup. Introduce rum and crushed ice, then stir delicately to ensure even distribution of mint leaves throughout the cocktail. Finish by adding soda water on top. Complete the presentation with a garnish of fresh mint sprig and lime wheel.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="classic_mojito.php" method="post">
