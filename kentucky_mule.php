...
$page_identifier = "kentucky_mule.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: kentucky_mule.php");
        exit;
    }
}
...
<img src="img/kentuckymule.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Kentucky Mule</h1>
        <p class="text-white pb-10">Not all mules originate in Moscow. This unique twist on the classic mule features Maker's Mark&reg;, fresh fruit, and cold ginger beer, adding a touch of Kentucky flair. Choose from an array of fruits like mango, strawberry, raspberry, and more to infuse this southern surprise with the vibrant flavors of summer. Cheers to enjoying a refreshing cocktail with a Kentucky twist!</p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">2 parts Maker's Mark&reg; bourbon</p>
            <p class="text-white pb-1">½ part Fresh lime juice</p>
            <p class="text-white pb-1">4 pieces of Fresh fruit(or a squeeze of purée)*</p>
            <p class="text-white pb-1">*Recommended fruit flavors: Mango, strawberry, lynchee, passionfruit, raspberry</p>
            <p class="text-white pb-1"></p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">Begin by muddling your choice of fruit in a shaker. Next, add Maker's Mark®, lime juice, bitters, and ice to the shaker. Shake vigorously, then strain the mixture into a glass filled with fresh ice. Top it off with ginger beer, and garnish with more of the fruit you used for muddling.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="kentucky_mule.php" method="post">
