...
$page_identifier = "tokyo_collins.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: tokyo_collins.php");
        exit;
    }
}
...
<img src="img/tokyocollins.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Tokyo Collins</h1>
        <p class="text-white pb-10">Transport yourself to Tokyo from the comfort of your home with this exquisite cocktail featuring Suntory&reg; Roku Gin. Light, elegant, and simple, this drink is perfect for any occasion, whether you're enjoying it in your kitchen, at the coffee table, or beyond. Cheers to experiencing a taste of Tokyo wherever you are!
            </p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1½ parts Suntory Roku&reg; gin</p>
            <p class="text-white pb-1">1 part Lemon juice</p>
            <p class="text-white pb-1">½ part Simple syrup</p>
            <p class="text-white pb-1">2 parts Club soda</p>
            <p class="text-white pb-1">Garnish: Cherry, Lemon slice</p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">In an ice-filled shaker, combine Suntory Roku® Gin, lemon juice, and simple syrup. Shake vigorously until well chilled, then strain into a Collins glass over fresh ice. Top with soda water and garnish with a cherry and lemon slice for a refreshing finishing touch.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="tokyo_collins.php" method="post">
