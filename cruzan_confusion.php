...
$page_identifier = "cruzan_confusion.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: cruzan_confusion.php");
        exit;
    }
}
...
<img src="img/cruzanconfusion.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Cruzan&reg; Confusion</h1>
        <p class="text-white pb-10">This island-inspired drink is as straightforward as they come, leaving only the delightful dilemma of who gets the first sip! Indulge in the luscious blend of coconut rum with the tropical essence of mango and pineapple. Quick to whip up, it's the perfect refreshment for a picnic or a relaxing day by the pool.</p>
    </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1 part Cruzan&reg; Coconut rum</p>
            <p class="text-white pb-1">1 part Cruzan&reg; Mango rum</p>
            <p class="text-white pb-1">1 splash Pineapple juice</p>
            <p class="text-white pb-1">Garnish: Pineapple, mango</p>
...
Simply mix over ice and serve for a quick and easy tropical treat. For an extra touch of flair, consider garnishing with a skewer featuring a pineapple wedge, a cube of mango, and a pineapple leaf. Enjoy the refreshing flavors of this island-inspired cocktail!</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="cruzan_confusion.php" method="post">
