...
$page_identifier = "french75.php"; // Change this to match the identifier for your page
...
<img src="img/french75.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">French 75</h1>
        <p class="text-white pb-10">Celebrate the start of the new year with a sophisticated cocktail that's perfect for any evening. Crafted with London Dry Gin and best enjoyed in the company of close friends, this classic cocktail is a toast to the beginning of another year filled with fantastic cocktail creations. Cheers to ringing in the new year in style!</p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1 part London dry gin</p>
            <p class="text-white pb-1">½ part Fresh squeezed lemon juice</p>
...
<div class="">
            ...
            In an ice-filled shaker, combine gin, lemon juice, and simple syrup. Shake vigorously until well chilled. Strain the mixture into a flute or coupe glass and top it off with champagne. Garnish with a twist of lemon for a touch of elegance. Enjoy your sparkling gin cocktail!</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="french75.php" method="post">
