...
$page_identifier = "cranberry_mojito.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: cranberry_mojito.php");
        exit;
    }
}
...
<img src="img/cranberrymojito.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Cranberry Mojito</h1>
        <p class="text-white pb-10">Infuse your go-to mint drink with a tart twist of red. This cranberry cocktail blends the classic flavors of a mojito with the tangy zing of fresh cranberries. Mint and simple syrup balance out the tartness, while rum adds depth and complexity to the mix. With its vibrant colors, this cocktail is perfect for holiday gatherings or casual hangouts with friends. Cheers to enjoying a refreshing and festive drink!</p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">2 parts Light rum</p>
            <p class="text-white pb-1">2 parts Cranberry simple syrup</p>
            <p class="text-white pb-1">10 Fresh mint leaves</p>
            <p class="text-white pb-1">1/4 part Lime juice</p>
            <p class="text-white pb-1">Soda water</p>
            <p class="text-white">Cranberries and lime wheel</p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">In a tall glass, combine mint leaves and lime juice, then lightly muddle them. Fill the glass with ice, then add cranberry simple syrup and light rum. Top it off with soda water and give it a gentle stir using a bar spoon. Optionally, garnish with fresh cranberries and lime slices.
            For the cranberry simple syrup, in a saucepan, combine 1 cup of water, 1 cup of sugar, and 8 oz of fresh cranberries. Bring the mixture to a light simmer over medium-high heat, stirring occasionally until the sugar is fully dissolved and the cranberries start to burst (usually around 10 minutes). Remove from heat and strain out the cranberries.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="cranberry_mojito.php" method="post">
