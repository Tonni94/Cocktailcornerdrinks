...
$page_identifier = "tequila_sunrise.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: tequila_sunrise.php");
        exit;
    }
}
...
<img src="img/tequilasunrise.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Tequila Sunrise</h1>
        <p class="text-white pb-10">Capture the fiery essence of a sunset with a simple yet captivating Tequila Sunrise. Featuring only tequila, this cocktail celebrates the spirit's bold flavor profile. Pour tequila over ice in a highball glass, allowing its golden hue to shine through. Slowly drizzle in grenadine syrup, letting it cascade through the tequila like the setting sun painting the sky. The result? A stunning gradient effect reminiscent of the horizon ablaze with red and orange hues. Garnish with a slice of orange to complete this captivating masterpiece.</p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">2 parts Tequila</p>
            <p class="text-white pb-1">1 part Lime juice</p>
            <p class="text-white pb-1">1 part Orange juice</p>
            <p class="text-white pb-1">3 parts Cranberry juice</p>
            <p class="text-white pb-1">Orange wedges</p>
            <p class="text-white">Lemon wedges</p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">
            Fill a shaker with all ingredients and shake vigorously. Strain the mixture into a glass over ice. Garnish with lemon and orange wedges for a citrusy touch. Enjoy your refreshing Tequila Sunrise!</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="tequila_sunrise.php" method="post">
