...
$page_identifier = "watermelon_mai_tai.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: watermelon_mai_tai.php");
        exit;
    }
}
...
<img src="img/watermelonmaitai.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Watermelon Mai tai</h1>
        <p class="text-white pb-10">Infuse the classic Polynesian Mai Tai with the refreshing essence of summer watermelon, and you've got yourself a mouthwatering Watermelon Mai Tai. Crafted with the rich depth of dark rum and watermelon schnapps, this cocktail is elevated with a splash of orange juice, pineapple juice, and grenadine, resulting in a vibrant taste of the islands.
        Perfect for summer gatherings, whether it's a lively summer party or a relaxing poolside soirée, this colorful concoction is sure to be a hit with your guests. Cheers to sipping on the essence of summer!
        </p>
    </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1 part Dark rum</p>
            <p class="text-white pb-1">1 DeKuyper&reg; Pucker&reg; Watermelon schnapps</p>
            <p class="text-white pb-1">1 part Orange juice</p>
            <p class="text-white pb-1">1 part Pineapple juice</p>
            <p class="text-white pb-1">1 splash Grenadine</p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">
            Start by pouring Pucker® Watermelon Schnapps into your glass, then fill it with a refreshing blend of orange and pineapple juices. Carefully float grenadine over the juice for a touch of sweetness. Give it a gentle shake or stir to blend the flavors.
            To finish, float a rich dark rum on top for a depth of flavor that complements the fruity notes perfectly. Enjoy this delicious Watermelon Mai Tai variation at your next gathering or poolside hangout!</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="watermelon_mai_tai.php" method="post">
