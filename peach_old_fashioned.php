...
$page_identifier = "peach_old_fashioned.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: peach_old_fashioned.php");
        exit;
    }
}
...
<img src="img/peacholdfashioned.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Peach Old Fashioned</h1>
        <p class="text-white pb-10">Whether it's rain or shine, brighten up your day with this delightful Old Fashioned concoction. Rich bourbon meets the luscious essence of peach liqueur, enhanced by the sweet notes of muddled cherries and oranges. The burst of fresh fruit balances any hint of bitterness, leaving you craving another sip.
            </p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">3 parts Bourbon</p>
            <p class="text-white pb-1">1 part Peach Liqueur</p>
            <p class="text-white pb-1">1 ½ slice Orange</p>
            <p class="text-white pb-1">1-2 Cherries</p>
            <p class="text-white pb-1">2 dashes Bitters</p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">Remove the stem from the cherry and place it into an old fashioned glass along with orange slices and bitters. Gently muddle with half a teaspoon of sugar. Fill the glass with ice, pour in the spirits, and stir well to blend. Finish off with a garnish of either a peach or orange slice.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="peach_old_fashioned.php" method="post">
