...
$page_identifier = "gimlet.php"; // Change this to match the identifier for your page
...
<img src="img/gimlet.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Gimlet</h1>
        <p class="text-white pb-10">Between brunch and late afternoon, take a moment to unwind with a refreshing sip of London Dry Gin. Kickstart your own summer celebration by grabbing an ice-filled shaker and mixing up this cocktail. Before you know it, you'll find yourself basking in the sunshine with this delightful drink in hand. Cheers to summer relaxation!</p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            ...
            <p class="text-white pb-1">1 part Fresh squeezed lime juice</p>
...
<div class="">
            ...
            In an ice-filled shaker, combine all ingredients and shake vigorously until well chilled. Strain the mixture into a cocktail glass and garnish with a lime wheel for a refreshing finishing touch</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="gimlet.php" method="post">
