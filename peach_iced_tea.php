...
$page_identifier = "peach_iced_tea.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: peach_iced_tea.php");
        exit;
    }
}
...
<img src="img/peachicedtea.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Peach Iced Tea</h1>
        <p class="text-white pb-10">Savor the delightful simplicity of this homemade peach vodka iced tea, a concoction that's both easy to whip up and packed with juicy sweetness. Simply mix one part peach-flavored vodka with two parts iced tea to create this tantalizing beverage. Enhance its flavors with a lemon wheel for a touch of tartness, making it an ideal companion for an al fresco picnic.
            </p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1 part Peach flavored vodka</p>
            <p class="text-white pb-1">2 parts Iced tea</p>
            <p class="text-white pb-1">Lemon wheel</p>
...
<div class="">
            ...
            <p class="text-white pb-5">Combine the ingredients in a glass filled with ice and garnish with a lemon wheel for an added burst of flavor and a touch of visual appeal.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="peach_iced_tea.php" method="post">
