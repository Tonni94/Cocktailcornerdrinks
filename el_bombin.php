...
$page_identifier = "el_bombin.php"; // Change this to match the identifier for your page
...
<img src="img/elbombin.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">El Bombin</h1>
        <p class="text-white pb-10">Radiant and rosy, this tequila martini is a splendid option for a fun-filled girls' night out or a laid-back summer soiree. Pair the velvety smoothness of tequila with the zesty kick of grapefruit juice, complemented by a hint of honey for a harmonious blend of flavors. Savor this visually captivating cocktail that promises to elevate any occasion with its vibrant hue and irresistible taste.</p>
        </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            ...
            <p class="text-white pb-1">1 part Fresh grapefruit juice</p>
            <p class="text-white pb-1">½ part Honey syrup</p>
            <p class="text-white pb-1">Garnish: Orange wheel</p>
...
<div class="">
            ...
            Combine the ingredients in a mixing glass with ice. Shake vigorously for 10 seconds to chill the mixture. Strain the cocktail into a martini glass and garnish with an orange wheel for an added touch of citrus elegance.</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="el_bombin.php" method="post" id="commentForm">
