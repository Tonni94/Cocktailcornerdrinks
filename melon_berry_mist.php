...
$page_identifier = "melon_berry_mist.php"; // Change this to match the identifier for your page
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && $logged_in) {
    ...
    if (!empty($comment)) {
        ...
        header("Location: melon_berry_mist.php");
        exit;
    }
}
...
<img src="img/melonberrymist.jpg" class="rounded-lg object-cover" alt="" style="width: 608px; height: 455px;">
<div class="flex flex-col justify-between">
<div class="bottom-0">
        <h1 class="text-white text-3xl text-start mb-4 uppercase">Melon Berry Mist</h1>
        <p class="text-white pb-10">
Indulge in the juicy essence of freshly picked berries with this delightful fruit cocktail. Muddled strawberries and cucumbers infuse this vodka-based drink with authentic fruit flavors, complemented by the sweet notes of Midori® melon liqueur. Complete the experience by garnishing with a crisp cucumber and savoring it outdoors, accompanied by a gentle warm breeze</p>
    </div>
...
<h1 class="text-white text-3xl uppercase mb-4">ingredients</h1>
            <p class="text-white pb-1">1 part Melon Liqueur</p>
            <p class="text-white pb-1">1 part Vodka</p>
            <p class="text-white pb-1">1 part Cranberry juice</p>
            <p class="text-white pb-1">3-4 Strawberries</p>
            <p class="text-white pb-1">1 Slice cucumber</p>
            <p class="text-white"></p>
        </div>
<div class="">
            <h1 class="text-white text-3xl text-start mb-4 uppercase">instructions</h1>
            <p class="text-white pb-5">
            Begin by muddling a handful of strawberries and two thick round slices of cucumber thoroughly. Add the remaining ingredients to the shaker, along with ice, and shake vigorously.
            Double strain the mixture into a chilled cocktail glass to ensure a smooth texture.
            Finally, garnish your creation with a fresh strawberry and a cucumber wheel for a visually appealing presentation. Cheers to your exquisite fruit-infused cocktail!</p>
        </div>
</div>
...
?>
        ...
        <!-- Post Comment Form -->
        <form class="mb-6" action="melon_berry_mist.php" method="post">
